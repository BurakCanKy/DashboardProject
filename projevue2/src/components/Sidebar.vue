    ...
    <nav class="sidebar" data-trigger="scrollbar">
      <div class="sidebar-body">
        <ul class="nav ">
          ...
          <li class="has-sub-item"><a href="#" @click="openEcommerce">
              <div class="flex">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                  <path
          ...
          <li><a href="../../../pages/social-media.html">
          ...
          <li class="has-sub-item"><a href="#" @click="openEmail">
              <div class="flex"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  class="w-6 h-6 mr-2">
                  <path fill-rule="evenodd"
          ...
          <li class="has-sub-item"><a href="#" @click="openToDoList">
              <div class="flex"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                  class="w-6 h-6 mr-2">
                  <path
...
export default {
  ...
  methods: {
    openEcommerce() {
      this.cssEccomerce == 'nav sub-menu' ? this.cssEccomerce = 'hidden' : this.cssEccomerce = 'nav sub-menu';
    },
    openEmail() {
      this.cssEmail == 'nav sub-menu' ? this.cssEmail = 'hidden' : this.cssEmail = 'nav sub-menu';
    },
    openToDoList() {
      this.cssToDoList == 'nav sub-menu' ? this.cssToDoList = 'hidden' : this.cssToDoList = 'nav sub-menu';
    }
  }
}
</script>
...
.sidebar .sidebar-body li a:after {
  position: absolute;
  content: "";
  background-image: url("https://themelooks.net/demo/dashmin/html/assets/img/svg/plus.svg");
  height: 12px;
  top: 10px;
  z-index: -1;
}
